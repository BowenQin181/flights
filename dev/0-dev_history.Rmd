...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Build A Package to analysis penguins data",
    ...
    `Authors@R` = c(
      person(given = "Bowen", family = "Qin", email = "qinbowen181@163.com",
       role = c("aut", "cre")
    )
  )),
  overwrite = TRUE)
...
fusen::inflate(flat_file = "dev/flat_penguins.Rmd", vignette_name = "Table by islands",
               overwrite = TRUE)
```
